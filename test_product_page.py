...
def test_guest_cant_see_success_message(self, browser):
    ...
    page.should_not_be_disappeared_success_message()    # будет ждать до тех пор, пока элемент не исчезнет
...
def test_guest_cant_see_success_message_after_adding_product_to_basket(browser):
    ...
    page.open()                      # открываем страницу
    page.add_to_basket()          # добавление книги
    page.should_not_be_success_message()    # упадет, как только увидит искомый элемент
...
class TestUserAddToBasketFromProductPage():
    ...
    def setup(self, browser):
        ...
        page.open()     # открываем страницу
        page.should_be_login_form()     # Переход к странице регестрации
        page.register_new_user()    # создание пользователя
        page.should_be_authorized_user()    # проверка на авторизованного пользователя
